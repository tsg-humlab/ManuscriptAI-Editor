...
@structure_bp.route('/api/process', methods=['POST'])
def process_file():
    """
    ...
    try:
        ...
        return render_template('results1.html', data=raw_text)
...
def send_manuscripts():
    ...
    try:
        ...
        return jsonify({"message": "Data received successfully!", "response": final_response_trimmed}), 200
