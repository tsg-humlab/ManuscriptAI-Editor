...
drop_classify_bp = Blueprint('drop_classify_bp', __name__)
# CORS(structure_bp)
...
#####################################
# The /api/drop-classify endpoint
#####################################
@drop_classify_bp.route('/api/drop-classify', methods=['POST'])
def drop_classify():
    ...
    return jsonify({"structured_data": merged_manuscripts})
